        ...
        <>
            ...
            <div className="px-40 py-5">
                ...
                <div className="pt-10 flex justify-evenly items-center flex-wrap">
                    <button className=" m-4 rounded-2xl shadow-md shadow-black w-40 h-40 bg-gradient-to-r from-indigo-500 to-cyan-400 text-slate-50 font-bold flex justify-center items-center active:bg-gradient-to-l">Telegate</button>
                </div>
            </div>
            <Footer/>
        </>
